...
{
    public class vivoController : BaseController
    {
        private const string enter_url = "http://www.chinazhihuiping.com/wxredpackets/vivo/Activity";
        private const string wx_url = "http://www.chinazhihuiping.com/wxredpackets/vivo/WXActivity";
        private const string money_url = "http://www.chinazhihuiping.com/wxredpackets/vivo/GiveMoney";
        private const string str_a_activityname = "【Vivo红包雨】";
        private const string str_b_activityname = "【Vivo红包雨】发生重定向-现金红包跳转";
        private const string str_c_activityname = "【Vivo红包雨】发生重定向-实物红包跳转";
        private const string str_d_activityname = "【Vivo红包雨】-实物已领取";
        private const string str_e_activityname = "【Vivo红包雨】-取奖品awardsModel.Class == \"\"";
        private const string str_f_activityname = "【Vivo红包雨】-取奖品awardsModel.Class == null";

        private const string activityName = "【Vivo红包雨】";
        private const string TenPaySender = "Vivo";
        private const string TenPayWish = "恭喜发财";
        private const string TenPayGame = "Vivo，红包雨";
        private const string TenPayRemark = "Vivo";
